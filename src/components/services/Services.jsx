...
const PictureServices = () => {
    return (<picture >
        ...
        <img loading='lazy' width={900} height={1350} className={style.img} src="images/kelniu_palenkimas_700.webp" alt="kelniu palenkimas šiauliuose" />
    </picture>
    )
};
export function Services() {
    ...
    return (
        <div id='repair' className={style.container}>
            <div className={style.picture}><PictureServices /></div>
