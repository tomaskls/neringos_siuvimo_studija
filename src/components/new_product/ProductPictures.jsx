...
export const Picture1 = () => {
    return (<picture >
        ...
        <img className={style.img} src="/img/zalias_dzemperis.webp" loading='lazy' alt="žalias džemperis" />
    </picture>
    )
};
export const Picture2 = () => {
    return (<picture >
        ...
        <img className={style.img} src="/img/dzemperis.webp" loading='lazy' alt="džemperis" />
    </picture>
    )
};
export const Picture3 = () => {
    return (<picture >
        ...
        <img className={style.img} src="/img/melynas_dzemperis.webp" loading='lazy' alt="melynas dzemperis" />
    </picture>
    )
};
export const Picture4 = () => {
    return (<picture >
        ...
        <img className={style.img} src="/img/moteriskas_flisinis_dzemperis.webp" loading='lazy' alt="moteriskas flisinis džemperis" />
    </picture>
    )
};
