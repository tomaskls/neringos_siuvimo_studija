...
const PictureRepair = () => {
    return (<picture >
        <source srcSet="images/rubu_taisymas_750.webp" media="(max-width: 780px)" />
        <img width={900} height={1350} className={style.img} src="images/rubu_taisymas_900.webp" alt="rūbų taisymas šiauliuose" />
    </picture>
    )
};
