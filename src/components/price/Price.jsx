        ...
        <div id='repair' className={style.container}>
            <div className={style.content1}>
                ...
                <div className={style.content}>
                    ...
                    <div className={style.list}>
                        ...
                        <p className={style.p}>Kelnių trumpinimas mašina - 8€</p>
            ...
            <div className={style.content2}>
                <div className={style.list}>
                    ...
                    <p className={style.p}>Sijono trumpinimas - 10€</p>
                    <p className={style.p}>Sijono trumpinimas su pamušalu - 12€</p>
                ...
                <div className={style.list}>
                    ...
                    <p className={style.p}>Švarko apačios trumpinimas - 15€</p>
                    <p className={style.p}>Švarko rankovių trumpinimas - 10€</p>
            ...
            <div className={style.list}>
                ...
                <p className={style.p}>Suknelės apačios lenkimas - 10€</p>
                <p className={style.p}>Suknelės plačia apačia su pamušalu trumpinimas - 20€</p>
                <p className={style.p}>Suknelės petnešų trumpinimas - 8€</p>
            ...
            <div className={style.list}>
                ...
                <p className={style.p}>Paltui - 24€</p>
                <p className={style.p}>Puspalčiui - 20€</p>
                <p className={style.p}>Švarkui - 15€</p>
                <p className={style.p}>Sijonui - 10€</p>
                <p className={style.p}>Suknelei - 15€</p>
                <p className={style.p}>Striukei - 20€</p>
            ...
            <div className={style.list}>
                ...
                <p className={style.p}>Vaikiška striukė - 12€</p>
